...
| image | object | `{"registry":"gsoci.azurecr.io"}` | Registry switch Do not overwrite this as the registry is automatically set based on the installation region |
...
| tapInjector.image.name | string | `"giantswarm/linkerd-tap"` | Docker image name for the tapInjector instance |
